...
For instance, take visually impaired people. These people have special needs and use specialised tools to help them
...
While I do like the tree representation and my brain is good at visualising these, you may prefer a linear list too.
...
your application is localised to deal with the variable length of your strings.

#### Careful when picking colours
Contrast is very important. Text with improper colour contrast may end up being completely unreadable for people who
struggle to perceive colour. Carefully picking the colours your text is written in, and ensuring a good contrast ratio
is essential.

Colours aren't sufficient to convey meaning either. While you may see a bright red error text, someone will see a text
...
In some colour-heavy illustrations, such as charts, you should consider making sure colours are distinguishable by
colourblind people, or that they use other features than colour to convey meaning. For example, line charts may use
different shapes of points and line patterns (solid, dotted, dashes, ...), pie charts may use different patterns to
fill each part instead of solid colours, etc.
...
- Localising your application is also making it accessible to foreign individuals. I recommend this
...
- The weight of your app (JS bundle sizes, image optimisations, etc.) counts as accessibility. People with metered
...
as tabs, highly customised form elements, tooltips, toasts, modals, and pretty much anything you might have to use in
...
Modern components allow for great customisability, and most UI kits out there are highly customisable. You shouldn't
...
styles on top of them, which is enough to customise them to suit all your needs.
...
provide components with predefined behaviour, and accessibility concerns already taken into account, and then leave
everything else up to you. You can think of them as a classic HTML elements, without styles, or anything.

This is a sweet spot of being low-level enough to fit in any single application, but abstracts away a lot of behaviour
and accessibility concerns out of view, so your app is accessible by default.

Radix isn't the only one, but it's my favourite. There are a few other alternative libraries, all with their pros and
...
starting block and customise it to your specific needs.
...
accessibility. By raising awareness and correcting certain behaviours, we can make sure the Internet is more accessible.
