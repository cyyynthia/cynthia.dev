...
## A simple solution
The worst (or best!) part is that there is a very simple solution to this problem: [`<use>`](https://developer.mozilla.org/en-GB/docs/Web/SVG/Element/use).
...
let you externalise the spritesheet, and it is forcefully embedded into your HTML template file.
...
non-standard behavior with how it processed the SVGs, and had little to no customisation possible. You couldn't tweak
